...
export type aiProps = {
  aiMsg: string;
  setAI: React.Dispatch<React.SetStateAction<string>>;
};
...
export type setLoaderValue = {
  setAiload: React.Dispatch<React.SetStateAction<boolean>>;
  setgridLoad: React.Dispatch<React.SetStateAction<boolean>>;
};

export type SuperLoad = {
  aiload: LoadProps;
  tableLoad: LoadProps;
};
...
function Face() {
  ...
  const [aiMessage, setAI] = useState("");
          ...
          <div className="sticky top-6 rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
            <div className="mb-5 border-b border-slate-200 pb-4 flex items-center justify-center flex-col">
              ...
              <p className="mt-1 text-sm text-slate-500">
                Quick facts and summarized intelligence about the selected
                region.
              </p>
            </div>
